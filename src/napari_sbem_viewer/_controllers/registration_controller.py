...
class RegistrationController:
    ...
    def _on_update_angle(self):
        ...
        if self.model.align_planes_model.t is not None:
            self.view.align_planes.position_slider.setValue(self.model.align_planes_model.t)
    
    def _on_update_position(self):
        self.model.align_planes_model.update_plane_position(self.view.align_planes.position_slider.value())
