...
class AcquisitionSettings(QGroupBox):
    def __init__(self):
        ...
        self.fine_thickness_spinbox = QSpinBox(
            maximum=999, value=DEFAULT_FINE_THICKNESS
        )
        self.pause_before_acquire_roi_checkbox = QCheckBox(
            'Pause before acquiring ROIs'
        )
        self.pause_after_acquire_roi_checkbox = QCheckBox(
            'Pause after acquiring ROIs'
        )
