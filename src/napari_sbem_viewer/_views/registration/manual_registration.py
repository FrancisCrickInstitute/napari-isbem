...
class ManualRegistration(QGroupBox):
    def __init__(self, parent=None):
        ...
        self.layout().addWidget(self.reverse_checkbox, 1, 0, 1, 2)
        
        self.move_amount_slider = QDoubleSpinBox(
            minimum=0.1, maximum=10, singleStep=0.1, value=1)
        self.layout().addWidget(QLabel("Move amount (µm):"), 2, 0)
        self.layout().addWidget(self.move_amount_slider, 2, 1)
        ...
        self.layout().addWidget(self.remove_outliers_checkbox, 4, 0, 1, 2)
        ...
        self.layout().addWidget(self.reset_button, 6, 0, 1, 2)
