...
class TCPServer(QThread):
    ...
    def add_grid(self, roi_id, x, y, w, h, template_grid=None, mask=None):
        self.response_commands.append({'msg': 'ADD ARRAY GRID', 'args': [template_grid, roi_id, [x, y], [w, h], 0, mask], 'kwargs': {}})
